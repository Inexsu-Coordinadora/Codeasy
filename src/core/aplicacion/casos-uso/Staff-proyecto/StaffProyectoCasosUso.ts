...
export class StaffProyectoCasosUso {
  ...
  // listar asignaciones
  async listarAsignaciones(id_proyecto?: string) {
  // Si tu repositorio tiene el método obtenerAsignaciones
    return this.staffRepositorio.obtenerAsignaciones(id_proyecto);
  }
